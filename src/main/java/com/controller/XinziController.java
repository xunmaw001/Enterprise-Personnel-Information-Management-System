    ...
    */
    ...
    public R save(@RequestBody XinziEntity xinzi, HttpServletRequest request){
        ...
        if(xinziEntity==null){
            ...
            //                          基本工资            加班工资                    奖金                      住房补贴                        吃饭补贴                工龄工资                    考勤工资
            Double shifaMoney = xinzi.getJibenMoney() + xinzi.getJiabanMoney() + xinzi.getJiangjinMoney() + xinzi.getZhufangMoney() + xinzi.getChifanMoney() + xinzi.getGonglingMoney() + xinzi.getKaoqinMoney()
                    //      保险费                     五险一金                        罚款
                    - xinzi.getBaoxianfeiMoney() - xinzi.getWuxianyijinMoney() - xinzi.getFakuanMoney();
            xinzi.setShifaMoney(shifaMoney);
            xinziService.insert(xinzi);
            return R.ok();
        }else {
            return R.error(511,"该员工该月已有工资条");
        }
    }
