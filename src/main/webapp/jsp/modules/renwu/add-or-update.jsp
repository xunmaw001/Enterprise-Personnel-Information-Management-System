                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>任务名称</label>
                                        <input id="renwuName" name="renwuName" class="form-control"
                                               placeholder="任务名称">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>任务类型</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>任务时间</label>
                                        <input id="renwuTime-input" name="renwuTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>任务详情</label>
...
<script>
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#renwuTime-input").val(ruleForm.renwuTime);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            if(window.sessionStorage.getItem('addrenwu') != null && window.sessionStorage.getItem('addrenwu') !=""){//新增查询,修改不查
                // 查询当前登录账户的信息
                var userId = window.sessionStorage.getItem('userId');
