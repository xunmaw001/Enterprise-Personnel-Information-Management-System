...
<script>
    ...
    //数字检查
        ...
        function jiabanMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function jiangjinMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function zhufangMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function chifanMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function gonglingMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function kaoqinMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function baoxianfeiMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function wuxianyijinMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function fakuanMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function shifaMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                month: "required",
                jibenMoney: "required",
                jiabanMoney: "required",
                jiangjinMoney: "required",
                zhufangMoney: "required",
                chifanMoney: "required",
                gonglingMoney: "required",
                kaoqinMoney: "required",
                baoxianfeiMoney: "required",
                wuxianyijinMoney: "required",
                fakuanMoney: "required",
                shifaMoney: "required",
            ...
            messages: {
                ...
                jibenMoney: "基本工资不能为空",
                jiabanMoney: "加班费不能为空",
                jiangjinMoney: "奖金不能为空",
                zhufangMoney: "住房补贴不能为空",
                chifanMoney: "吃饭补贴不能为空",
                gonglingMoney: "工龄费不能为空",
                kaoqinMoney: "考勤费不能为空",
                baoxianfeiMoney: "保险费不能为空",
                wuxianyijinMoney: "五险一金缴纳金额不能为空",
                fakuanMoney: "罚款不能为空",
                shifaMoney: "实发金额不能为空",
                xinziContent: "备注不能为空",
                insertTime: "发放时间不能为空",
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jiabanMoney").val(ruleForm.jiabanMoney);
        $("#jiangjinMoney").val(ruleForm.jiangjinMoney);
        $("#zhufangMoney").val(ruleForm.zhufangMoney);
        $("#chifanMoney").val(ruleForm.chifanMoney);
        $("#gonglingMoney").val(ruleForm.gonglingMoney);
        $("#kaoqinMoney").val(ruleForm.kaoqinMoney);
        $("#baoxianfeiMoney").val(ruleForm.baoxianfeiMoney);
        $("#wuxianyijinMoney").val(ruleForm.wuxianyijinMoney);
        $("#fakuanMoney").val(ruleForm.fakuanMoney);
        $("#shifaMoney").val(ruleForm.shifaMoney);
    ...
    function yonghuDataBind(){
        ...
        $("#chushengriqiTime").val(ruleForm.chushengriqiTime);
        $("#ruzhiTime").val(ruleForm.ruzhiTime);
        $("#yonghuContent").val(ruleForm.yonghuContent);
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            if(window.sessionStorage.getItem('addxinzi') != null && window.sessionStorage.getItem('addxinzi') !=""){//新增查询,修改不查
                // 查询当前登录账户的信息
                var userId = window.sessionStorage.getItem('userId');
            ...
            // 加班费设置不可选
            $('#jiabanMoney').attr('readonly', 'readonly');
            // 奖金设置不可选
            $('#jiangjinMoney').attr('readonly', 'readonly');
            // 住房补贴设置不可选
            $('#zhufangMoney').attr('readonly', 'readonly');
            // 吃饭补贴设置不可选
            $('#chifanMoney').attr('readonly', 'readonly');
            // 工龄费设置不可选
            $('#gonglingMoney').attr('readonly', 'readonly');
            // 考勤费设置不可选
            $('#kaoqinMoney').attr('readonly', 'readonly');
            // 保险费设置不可选
            $('#baoxianfeiMoney').attr('readonly', 'readonly');
            // 五险一金缴纳金额设置不可选
            $('#wuxianyijinMoney').attr('readonly', 'readonly');
            // 罚款设置不可选
            $('#fakuanMoney').attr('readonly', 'readonly');
            // 实发金额设置不可选
            $('#shifaMoney').attr('readonly', 'readonly');
        }else{
            // alert("未知情况.......");
        }
    }
