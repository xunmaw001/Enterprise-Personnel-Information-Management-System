                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>出生日期</label>
                                        <input id="chushengriqiTime-input" name="chushengriqiTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>入职时间</label>
                                    ...
                                    <div class="form-group  col-md-6">
                                        <label>详细介绍</label>
                                        <input id="yonghuContentupload" name="file" type="file">
...
<script>
    ...
    function upload() {
        ...
        $('#yonghuContentupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                UE.getEditor('yonghuContentEditor').execCommand('insertHtml', '<img src=\"' + baseUrl + 'upload/' + data.result.file + '\" width=900 height=560>');
            }
        });
    ...
    function setContent() {
        ...
        <!-- 当前表的填充富文本框 -->
        if (ruleForm.yonghuContent != null && ruleForm.yonghuContent != 'null' && ruleForm.yonghuContent != '' && $("#yonghuContentupload").length>0) {
    ...
    function getContent() {
        ...
        <!-- 获取当前表的富文本框内容 -->
        if($("#yonghuContentupload").length>0) {
            var yonghuContentEditor = UE.getEditor('yonghuContentEditor');
            if (yonghuContentEditor.hasContents()) {
                $('#yonghuContent-input').attr('value', yonghuContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                bumenTypes: "required",
                zhiwuTypes: "required",
                chushengriqiTime: "required",
                ruzhiTime: "required",
                yonghuContent: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                yonghuNumber: "员工编号不能为空",
                yonghuName: "姓名不能为空",
                yonghuPhone: "手机号不能为空",
                ...
                bumenTypes: "部门不能为空",
                zhiwuTypes: "职务不能为空",
                chushengriqiTime: "出生日期不能为空",
                ruzhiTime: "入职时间不能为空",
                yonghuContent: "详细介绍不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#chushengriqiTime-input").val(ruleForm.chushengriqiTime);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            $('#ruzhiTime-input').attr('readonly', 'readonly');
            $('#bumenTypesSelect').attr('readonly', 'readonly');
            $('#bumenTypesSelect').attr('style', 'pointer-events: none;');
            $('#zhiwuTypesSelect').attr('readonly', 'readonly');
            $('#zhiwuTypesSelect').attr('style', 'pointer-events: none;');
            var yonghuContentUeditor = UE.getEditor('yonghuContentEditor');
            yonghuContentUeditor.ready(function () {
