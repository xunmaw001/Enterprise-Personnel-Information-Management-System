...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
            ...
            var ruzhiTimeStartSearch = $('#ruzhiTimeStartSearch');
            if( ruzhiTimeStartSearch != null){
                if (ruzhiTimeStartSearch.val() != null && ruzhiTimeStartSearch.val() != '') {
                    searchForm.ruzhiTimeStart = $('#ruzhiTimeStartSearch').val();
                }
            }
            var ruzhiTimeEndSearch = $('#ruzhiTimeEndSearch');
            if( ruzhiTimeEndSearch != null){
                if (ruzhiTimeEndSearch.val() != null && ruzhiTimeEndSearch.val() != '') {
                    searchForm.ruzhiTimeEnd = $('#ruzhiTimeEndSearch').val();
                }
            }
                    getDataList();
        }
        ...
        function setDataRow(item, number) {
            ...
            resetPasswordBtn.setAttribute("class", "btn btn-info btn-sm 查看");
            resetPasswordBtn.setAttribute("onclick", resetPasswordAttr);
            resetPasswordBtn.innerHTML = "查看";
        ...
        function resetPassword(id) {
            window.sessionStorage.setItem("updateId", id);
            window.location.href = "info.jsp";
            httpJson("yonghu/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
