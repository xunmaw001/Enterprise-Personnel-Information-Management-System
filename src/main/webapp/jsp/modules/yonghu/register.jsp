                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <div class="form-group col-md-12">
                                       <label>出生日期</label>
                                       <input id="chushengriqiTime-input" name="chushengriqiTime" size="20"  type="month" class="form-control">
                                   </div>
                                   <div class="form-group col-md-12">
                                       <label>入职时间</label>
                                       <input id="ruzhiTime-input" name="ruzhiTime" size="20"  type="month" class="form-control">
                                   </div>
                                   <div class="form-group  col-md-12">
                                       <label>详细介绍</label>
