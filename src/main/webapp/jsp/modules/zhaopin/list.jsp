...
<!--/Pre Loader -->
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="zhaopinNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="招聘名字" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //招聘时间
            var zhaopinTimeCell = document.createElement('td');
            zhaopinTimeCell.innerHTML = item.zhaopinTime;
            row.appendChild(zhaopinTimeCell);


            //招聘人数
            var zhaopinNumberCell = document.createElement('td');
            zhaopinNumberCell.innerHTML = item.zhaopinNumber;
            row.appendChild(zhaopinNumberCell);
